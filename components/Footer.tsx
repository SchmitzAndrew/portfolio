...
export default function Footer() {
    return (
        <footer className="pt-6">
            <div className="mx-auto max-w-4xl pb-6 md:flex md:items-center md:justify-between px-6">
                <div className="flex justify-center space-x-8 md:order-2">
                    {navigation.map((item) => (
                        <a key={item.name} href={item.href} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-gray-500">
